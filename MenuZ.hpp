...
//		DrawSlider("", 4, 12, y += add, 180, 500, gCvars.misc_serverlag_value);
	DrawButton("SpeedHack ON", 4, 8, y += add, gCvars.misc_speedhack);
	DrawButton("SpeedHack OFF", 4, 8, y += add, gCvars.misc_speedhack2);
	...
	DrawButton("Fix Yaw : Left", 4, 8, y += add, gCvars.aimbot_resolver2);
	DrawButton("Fix Yaw : right", 4, 8, y += add, gCvars.aimbot_resolver3);
	DrawButton("Fix Yaw : forward", 4, 8, y += add, gCvars.aimbot_resolver4);
	DrawButton("Fix Yaw : backwards", 4, 8, y += add, gCvars.aimbot_resolver5);
	DrawButton("Fix Pitch", 1, 8, y += add, gCvars.aimbot_resolver);
